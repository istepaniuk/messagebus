...
parser = argparse.ArgumentParser(description='Gets messages from the dead-letter queue, optionally filtering by original queue name.')
parser.add_argument('--queue_name', metavar='ORIGINAL_QUEUE_NAME', type=str,
                   help='the name of the queue for which the messages were rejected')
