...
class Consumer:
    ...
    def _on_channel_opened(self, new_channel):
        ...
        new_channel.exchange_declare(self._on_dlx_declared,
                                     self.dead_letter_exchange, 'fanout',
                                     durable=True)
        new_channel.exchange_declare(self._on_exchange_declared, self.exchange,
                                     'topic', durable=True)
